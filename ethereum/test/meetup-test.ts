...
describe("Meetup", function () {
  ...
  let startsDate: BigNumberish = ethers.BigNumber.from(1690020072); //11 Jul 2023 11:48:46 GMT
  let endsDate: BigNumberish = ethers.BigNumber.from(1690056072); //11 Jul 2023 21:48:46 GMT
