...
describe("Meetup", function () {
  ...
  let startsDate: BigNumberish = ethers.BigNumber.from(1689150196); //11 Jul 2023 11:48:46 GMT
  let endsDate: BigNumberish = ethers.BigNumber.from(1689186196); //11 Jul 2023 21:48:46 GMT
